...
4. **Run the command** using Bash from the repo root (`c:\Users\rafael.giovannini\Documents\GitHub\AI-Brain`):
   ```bash
   cd /c/Users/rafael.giovannini/Documents/GitHub/AI-Brain && ./ralph-loop.sh <workspace> <flags>
   ```
